...
def main():
    ...
    parser.add_argument(
        "-c",
        "--compress",
        help="If this flag is given, then " "the output file will be compressed",
        action="store_true",
    )
    ...
    parser.add_argument(
        "-q",
        "--quality-mean",
        help="The mean quality score to " "use in the fastq file",
        type=int,
    ...
    parser.add_argument(
        "--quality-std",
        help="The standard deviation in the " "quality scores",
        type=int,
