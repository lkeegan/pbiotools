...
def main():
    ...
    parser.add_argument(
        "bed_a", help="The bed file from which entries will be " "removed"
    )
    parser.add_argument(
        "bed_b", help="The bed file used to find entries in A " "to remove"
    )
    ...
    parser.add_argument(
        "--exons-a",
        help="As with the --exons argument, but " "these exons will only be used for A",
        default=None,
    )

    parser.add_argument(
        "--exons-b",
        help="As with the --exons argument, but " "these exons will only be used for B",
        default=None,
    )
    ...
    parser.add_argument(
        "-p",
        "--num-cpus",
        help="The number of CPUs to use for " "certain parts of the script",
        type=int,
    ...
    if exons_a_only or exons_b_only:
        msg = (
            "Only one of --exons-a, --exons-b was given. This is valid, "
