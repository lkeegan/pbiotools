...
def test_get_transcript_overlap_fractions(bed_data):
    ...
    transcript_fractions = bed_utils.get_transcript_overlap_fractions(
        transcript_overlaps,
        bed_data.a_lengths_map,
        bed_data.b_lengths_map)
...
def test_get_bed_overlaps(bed_data):
    bed_overlaps = bed_utils.get_bed_overlaps(bed_data.a_df, bed_data.b_df, min_a_overlap=0.33, min_b_overlap=0.5)
...
def test_subtract_bed(bed_data):
    ...
    min_a_overlap = 0.2
    result = bed_utils.subtract_bed(bed_data.a_diff_df, bed_data.b_diff_df, min_a_overlap=min_a_overlap)
    assert result == expected_result

    # and requiring more substantial overlap of B
    expected_result = {1, 2, 3, 4}
    min_b_overlap = 0.3
    result = bed_utils.subtract_bed(bed_data.a_diff_df, bed_data.b_diff_df, min_b_overlap=min_b_overlap)
    assert result == expected_result
